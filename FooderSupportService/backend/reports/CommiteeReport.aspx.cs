...
{
    public partial class CommiteeReport : System.Web.UI.Page
    {
        ...
        //        oracleCommand.CommandText = "select * FROM VW_COMMITTEE_REPORT WHERE REVIEWED_DATE between TO_DATE('"+ ReviwedDateFrom.ToString("yyyy-MM-dd HH:mm:ss") + "', 'YYYY-MM-DD HH24:MI:SS') and TO_DATE('" + ReviwedDateTo.ToString("yyyy-MM-dd") + " 23:59:59', 'YYYY-MM-DD HH24:MI:SS')";
        ...
        //        tableRowTotal.Cells.Add(new TableCell() { ColumnSpan=6 });
        //        //tableRowTotal.Cells.Add(new TableCell());
        //        //tableRowTotal.Cells.Add(new TableCell());
        //        //tableRowTotal.Cells.Add(new TableCell());
        //        //tableRowTotal.Cells.Add(new TableCell());
        //        //tableRowTotal.Cells.Add(new TableCell());
