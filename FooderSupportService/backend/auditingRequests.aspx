<%@ Page Title="" Language="C#" MasterPageFile="~/backend/Backend.Master" AutoEventWireup="true" CodeBehind="auditingRequests.aspx.cs" Inherits="FooderSupportService.backend.auditingRequests" %>
    ...
    <div class="centered-div">
        <div class="table-container">
            <div class="rtl-div bold">
                <asp:Button ID="btn_underReview" CssClass="red-button" Font-Bold="true"  runat="server" Text="قيد المراجعة" Visible="true" OnClick="btn_underReview_Click" />
                <asp:Button ID="btn_underAuditing" CssClass="red-button" runat="server" Font-Underline="true" Text="قيد التدقيق" Visible="true" OnClick="btn_underAuditing_Click"/>
    ...
    <div class="centered-div">
        <div class="table-container">
            <div class="rtl-div bold">
             ...
             <div class="rtl-div bold">
                عدد الطلبات الغير مدققة(<asp:Label ID="lbl_count" runat="server" Text="5"></asp:Label>)
            </div>
            <div style="text-align: center;">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" EnableCallBacks="false" Theme="Default" Width="1400px" KeyFieldName="REQ_ID" AutoGenerateColumns="False" RightToLeft="True" OnSelectionChanged="ASPxGridView1_SelectionChanged" OnDataBinding="ASPxGridView1_DataBinding">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn Caption="المراجع" FieldName="REVIEWED_BY"></dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="تاريخ المراجعة" FieldName="REVIEWED_DATE"></dx:GridViewDataColumn>
                    </Columns>
                </dx:ASPxGridView>
            </div>
        </div>
