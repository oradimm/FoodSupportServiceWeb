Oracle.ManagedDataAccess NuGet Package 12.1.24230118 README
===========================================================
Release Notes: Oracle Data Provider for .NET, Managed Driver

January 2023

This README supplements the main ODP.NET 12.1 documentation.
https://docs.oracle.com/cd/E63277_01/index.htm
...
(i.e. Policy.4.121.Oracle.ManagedDataAccess.dll) for the ODP.NET, Managed Driver, version 4.121.2.0
...
Installation Changes
====================
The following app/web.config entries are added by including the Oracle.ManagedDataAccess NuGet package 
to your application:
